  ...
  useEffect(() => {
    async function load() {
      ...
      try {
        ...
        // 1. Check if this is a known sub-category
        const subCat = accessoryCategories.find((c: any) => c.slug === params.category);
        if (subCat) {
          setIsSubCategory(true);
          setIsLoading(false);
          // Redirect to proper sub-category page
          router.replace(`/shop/bike-accessories/category/${params.category}`);
          return;
        }
