...
export default function ProductPageClient({ product, related, categorySlug }: Props) {
  ...
  const isTShirt = categorySlug === 'tshirts' || categorySlug === 't-shirts' || product?.category === 'tshirts';
  const isBikeAccessory = categorySlug === 'bike-accessories' || product?.category === 'bike-accessories';
