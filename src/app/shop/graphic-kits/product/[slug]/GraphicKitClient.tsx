...
export default function GraphicKitClient({ product, related, categorySlug }: Props) {
  ...
  const [selectedModel, setSelectedModel] = React.useState(product.meta_data?.compatible_models?.[0] || '');
