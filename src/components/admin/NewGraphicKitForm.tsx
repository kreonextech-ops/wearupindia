    ...
    <form ref={formRef} action={clientAction} className="space-y-6 max-h-[70vh] overflow-y-auto pr-4 custom-scrollbar pb-10">
      ...
      <div className="space-y-3">
        ...
        <div className="relative group">
          {preview ? (
            <div className="relative aspect-[4/3] max-w-sm mx-auto rounded-2xl overflow-hidden border border-white/10">
            ...
            <label className="flex flex-col items-center justify-center aspect-[4/3] max-w-sm mx-auto rounded-2xl border-2 border-dashed border-white/5 bg-white/[0.02] hover:bg-white/[0.04] hover:border-[#E8161B]/30 transition-all cursor-pointer group">
